...
export function WelcomeStep(): JSX.Element {
  ...
  return (
    <div className="flex flex-col h-full">
      ...
      {/* Fixed footer with Get Started button - always visible */}
      <div className="flex-shrink-0 pt-6 border-t border-macos-separator dark:border-macos-separator-dark mt-6">
